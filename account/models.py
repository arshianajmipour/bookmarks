...
class Report(models.Model):
    ...
    report_date = models.DateField(null=True, blank=False, verbose_name='Report Date')
    effective_date = models.DateField(null=True, blank=False, verbose_name='Effective Date')
    ref_code = models.CharField(max_length=300, null=True, blank=False, verbose_name='Ref Code')
